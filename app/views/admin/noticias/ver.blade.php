...
<h1 class="page-header"><b><i class="fa fa-chevron-right"></i><i class="fa fa-chevron-right"></i> Ver noticas</b></h1>
    ...
    <table class="table table-striped table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a style="text-decoration: none; color: #008CBA;" href="{{URL::to('admin-editar-noticia', [$noticia->id]);}}"><i title="Editar" class="fa fa-pencil fa-2x hover-grey"></i></a></td>
                <td><a style="text-decoration: none; color: #008CBA;" href="{{URL::to('admin-eliminar-noticia', [$noticia->id]);}}"><i title="Eliminar" class="fa fa-times fa-2x hover-grey"></i></a></td>
            </tr>
            @endforeach
        </tbody>
    </table> 
